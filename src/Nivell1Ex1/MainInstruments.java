...
s’ha d’implementar a les classes filles. Si s’està tocant un instrument de vent, el mètode ha de mostrar per consola:
"Està sonant un instrument de vent", si s’està tocant un instrument de corda: “Està sonant un instrument de corda”
i si s’està tocant un instrument de percussió: “Està sonant un instrument de percussió”.

El procés de càrrega d'una classe només té lloc una vegada. Demostra que la càrrega pot ser provocada per la creació
...
public class MainInstruments {
    public static void main(String[] args) {
        ...
        InstrumentCorda instrument1 = new InstrumentCorda("Guitarra", 125.75f);
        InstrumentVent instrument2 = new InstrumentVent("Flauta", 15.50f);
        InstrumentPercussio instrument3 = new InstrumentPercussio("Djembé", 95.25f);
